...
class MapViewScreen extends Component {
    ...
    componentDidMount = async () => {
        const { distanceTravelled,currPos,destPos, tDist } = this.state
        ...
        const totalDist = haversine(currPos, destPos)
        this.setState({tDist: totalDist})
    ...
    endJourney = () => {
        ...
        this.props.navigation.navigate('FPEXP', { distanceTravelled: 100, tDist: 200, currPos: "source address", destPos: "destination address"}); //this.state.distanceTravelled, Dist: this.state.tDist });
